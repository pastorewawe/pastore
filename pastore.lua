...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/pastoreTEAM/File_Bot/File_Bot/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevpastoreW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local pastore_Msg = ''  
if msgs < 100 then 
pastore_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
pastore_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
pastore_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
pastore_Msg = 'متفاعل' 
elseif msgs < 1200 then 
pastore_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
pastore_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
pastore_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
pastore_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
pastore_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
pastore_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
pastore_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
pastore_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
pastore_Msg = 'رب التفاعل'  
end 
return pastore_Msg 
end
...
--------
function Sourcepastore(msg,data) -- بدايه العمل
if msg then
...
if start then 
Sourcepastorer = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'باستوري')
Sourcepastorer = '*⌯︙اهلا عزيزي*\n*⌯︙انا بوت اسمي '..Namot..'*\n*⌯︙اختصاصي حمايه الكروبات*\n*⌯︙من تكرار والسبام والتوجيه والخ…*\n*⌯︙لتفعيلي اتبع الاخطوات…↓*\n*⌯︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع -›{ منشئ او المشرفين } بتفعيل فقط*\n⌯︙[قناة سورس البوت](http://t.me/ieeo3s)'
end
send(msg.chat_id_, msg.id_, Sourcepastorer) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevpastoreW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevpastoreW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,pastore_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevpastoreW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevpastoreW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevpastoreW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevpastoreW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevpastoreW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevpastoreW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevpastoreW(msg) then 
os.execute('rm -rf pastore.lua')
os.execute('wget https://raw.githubusercontent.com/pastorewawe/pastore/main/pastore.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس باستوري*\n*⌯︙الاصدار -› { 2.8v}*')
dofile('pastore.lua')  
end
if text == 'الاصدار ⌯' and DevpastoreW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس باستوري* \n*⌯︙الاصدار -›{ 2.8v}*')
end
if text == "ضع اسم للبوت ⌯" and DevpastoreW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevpastoreW(msg) then 
...
if text == 'المشتركين ⌯' and DevpastoreW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين-› {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevpastoreW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات-› {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevpastoreW(msg) then
...
if text == ("قائمه العام ⌯") and DevpastoreW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevpastoreW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevpastoreW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevpastoreW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevpastoreW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevpastoreW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevpastoreW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevpastoreW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevpastoreW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevpastoreW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان -› { '..#group..' }'..pastorek..''..pastore..'*\n*⌯︙الان عدد الكروبات الحقيقي -› { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevpastoreW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevpastoreW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevpastoreW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevpastoreW(msg) then
...
local pastore1_Msg = database:get(bot_id.."pastore1:Add:Filter:Rp2"..text..msg.chat_id_)   
if pastore1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ieeo3s')..') \n ⌯︙'..pastore1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------
if pastore_Msg and not Special(msg) then  
local pastore_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if pastore_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..pastore_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/ieeo3s)}\n⌯︙["..pastore_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا -›* {["..data.first_name_.."](T.ME/ieeo3s)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevpastoreW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevpastoreW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevpastoreW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevpastoreW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevpastoreW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevpastoreW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevpastoreW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevpastoreW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevpastoreW(msg) then  
...
database:sadd(bot_id.."pastore:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."pastore:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_pastore = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_pastore then 
names_pastore = database:smembers(bot_id.."pastore:blocname"..msg.chat_id_) or ""
if names_pastore and names_pastore[1] then 
for i=1,#names_pastore do 
if name_pastore:match("(.*)("..names_pastore[i]..")(.*)") then 
...
database:set(bot_id.."pastore:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."pastore:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."pastore:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."pastore:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."pastore:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_pastorea_new(pastore1,pastore2)
if pastore2 and pastore2.first_name_ then 
if pastore2.first_name_:match("(.*)"..database:get(bot_id.."pastore:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."pastore:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local pastore_nnn = database:get(bot_id.."pastore:nump"..msg.chat_id_) or 5
local pastore_nnn2 = database:get(bot_id.."pastore:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(pastore_nnn2) == tonumber(pastore_nnn) or tonumber(pastore_nnn2) > tonumber(pastore_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."pastore:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..pastore2.username_.."](https://t.me/"..(pastore2.username_ or "ieeo3s")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."pastore:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(pastore_nnn) - tonumber(pastore_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_pastorea_new)
end
end
...
local pastoreChengName = database:get(bot_id.."pastore:Cheng:Name"..data.id_)
if not data.first_name_ then 
if pastoreChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..pastoreChengName..']')
database:del(bot_id.."pastore:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if pastoreChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."pastore:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local pastoreChengUserName = database:get(bot_id.."pastore:Cheng:UserName"..data.id_)
if not data.username_ then 
if pastoreChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..pastoreChengUserName..']')
database:del(bot_id.."pastore:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if pastoreChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."pastore:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local pastoreChengPhoto = database:get(bot_id.."pastore:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if pastoreChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."pastore:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if pastoreChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."pastore:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevpastoreW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ieeo3s')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ieeo3s')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == 'تحديث' and DevpastoreW(msg) then
dofile('pastore.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevpastoreW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevpastoreW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if pastoreSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevpastoreW(msg) then
...
if pastoreSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevpastoreW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevpastoreW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevpastoreW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevpastoreW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevpastoreW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevpastoreW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevpastoreW(msg) then
...
if text == ("مسح المطورين") and DevpastoreW(msg) then
...
if text == 'الملفات' and DevpastoreW(msg) then
t = ' *⌯︙ملفات السورس باستوري ↓*\n*•━━━━━━ 𝑷𝑨 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevpastoreW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/pastoreTEAM/File_Bot/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات باستوري*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝑷𝑨 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝑷𝑨 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس باستوري ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/ieeo3s) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevpastoreW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/pastoreTEAM/Files_pastore/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('pastore.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس باستوري* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevpastoreW(msg) then
...
if text == "مسح الملفات" and DevpastoreW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevpastoreW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevpastoreW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_pastore, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو -›* ['..data.first_name_..'](t.me/'..(data.username_ or 'ieeo3s')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو -›* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو -›* ['..data.first_name_..'](t.me/'..(data.username_ or 'ieeo3s')..')'
...
database:set(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."pastore1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."pastore1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."pastore1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."pastore1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."pastore1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."pastore1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."pastore1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."pastore1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."pastore1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."pastore1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."pastore1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌯︙قائمة المنع* \n*•━━━━━━ 𝑷𝑨 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local pastore_Msg = database:get(bot_id.."pastore1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." -› {"..pastore_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevpastoreW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevpastoreW(msg) then
...
if text == 'تفعيل الاذاعه' and DevpastoreW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevpastoreW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'باستوري').."" then  
...
send(msg.chat_id_, msg.id_,'['..pastore_Msg[math.random(#pastore_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevpastoreW(msg) then 
...
if pastoreSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevpastoreW(msg) then 
...
if text == ("ردود المطور") and DevpastoreW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝑷𝑨 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevpastoreW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevpastoreW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'باستوري').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevpastoreW(msg) then   
...
if text == 'تعطيل المغادره' and DevpastoreW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'pastore')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ieeo3s')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
pastoredx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة -› ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه -› ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين -› ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء -› ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'نقل الاحصائيات' and DevpastoreW(msg) then
...
if text == 'استعاده الاوامر' and DevpastoreW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝑷𝑨 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[𝑷𝒂𝑺𝒕𝑶𝒓𝑬 𝘴𝘰𝘳𝘶𝘤𝘦](t.me/ieeo3s) ')
end
...
{{text = '𝑷𝒂𝑺𝒕𝑶𝒓𝑬 𝒔𝒐𝒓𝒖𝒄𝒆.',url="t.me/ieeo3s"}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'باستوري')
...
pastore = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(pastore)
...
--------
Sourcepastore(data.message_,data)
...
----
local pastoreAbot = database:get(bot_id.."pastore1:Add:Filter:Rp2"..text..result.chat_id_)   
if pastoreAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..pastoreAbot.."] \n") 
...
----
if text then
local pastore1_Msg = database:get(bot_id.."pastore1:Add:Filter:Rp2"..text..result.chat_id_)   
if pastore1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..pastore1_Msg)
